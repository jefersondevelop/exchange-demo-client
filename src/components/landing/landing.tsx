...
import { Grid, Card, CardContent, Select, List, ListItem, ListItemIcon, ListItemText, MenuItem, Grow, Slide, InputAdornment } from '@material-ui/core';
                    ...
                    <CardContent style={{ width: '100%', display: 'block', margin: 'auto' }}>
                                ...
                                <Grid container spacing={1}>
                                    ...
                                    <Grid item xs={6} md={6} sm={6}>
                                        <Select
                                            ...
                                            label="Age"
                                            style={{ padding: 40, fontSize: 35, width: '100%', color: '#3f50b5c7' }}
                                            value={source}
                                            name="exchange"
                                        ...
                                        >
                                            ...
                                            <MenuItem style={{ width: '100%', fontSize: 35, color: '#3f50b5c7' }} value="-1">Ninguno</MenuItem>
                                            {
                                                distinctExchanges(exchanges).map((exchange: any, index: any) => (
                                                    <MenuItem style={{ width: '100%', fontSize: 35, color: '#3f50b5c7' }} key={index} value={exchange}>{exchange.sourceName}</MenuItem>
                                                ))
                                            }
                                        </Select>
                                    </Grid>
                                        ...
                                        >
                                            ...
                                            <MenuItem style={{ width: '100%', fontSize: 35, color: '#3f50b5c7' }} value="-1">Ninguno</MenuItem>
                                            {
                                                targets.map((exchange: any, index: any) => (
                                                    <MenuItem style={{ width: '100%', fontSize: 35, color: '#3f50b5c7' }} key={index} value={exchange}>{exchange.targetName}</MenuItem>
                                                ))
                                            }
                                        </Select>
                                    </Grid>
                        ...
                        >
                            <Grid item xs={12} md={12} sm={12} >
                                <Link to={(source === '-1' || sourceValue <= 0) ? '' : 'login'} style={{ textDecoration: 'none' }}>
                                    <JButton
                                        title='Siguiente'
                                        size="large"
                                        color="primary"
